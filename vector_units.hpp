...
namespace boost_test
{
	...
	public:
		...
		vector_units cross(const vector_units &v) const
		{
			...
			auto z1 = (static_cast<boost::units::quantity<U3, Type>>(x) * static_cast<boost::units::quantity<U3, Type>>(v.gety()) - static_cast<boost::units::quantity<U3, Type>>(y) * static_cast<boost::units::quantity<U3, Type>>(v.getx()));
